 ...
 */
export type Match = <A, B>(onNone: undefined, onSome: undefined) => (x: undefined) => undefined;
export const match: Match = (onNone, onSome) => x => undefined;
 ...
 */
export type MatchW = <A, B, C>(onNone: undefined, onSome: undefined) => (x: undefined) => undefined;
export const matchW: MatchW = (onNone, onSome) => x => undefined;
