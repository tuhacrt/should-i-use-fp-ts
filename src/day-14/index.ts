 ...
 */
type DoType = undefined;
export const Do: DoType = undefined;
 ...
 */
export type Bind =
  <N extends string, A, B>(name: undefined, f: (a: undefined) => O.Option<undefined>)
    => (ma: undefined)
...
export const bind: Bind = (name, f) => ma => pipe(
  ...
  O.flatMap(a => pipe(
    f(undefined),
    O.map(b => Object.assign({}, a, { [undefined]: b }) as any),
  )),
);
