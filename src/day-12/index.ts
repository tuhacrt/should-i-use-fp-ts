 ...
 */
type Alt = <A>(that: undefined) => (me: undefined) => undefined;
export const alt: Alt = that => me => undefined;
 ...
 */
export type AltW = <A, B>(that: undefined) => (me: undefined) => undefined;
export const altW: AltW = that => me => undefined;
